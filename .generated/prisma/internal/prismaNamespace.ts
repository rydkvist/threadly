...
> = {
  ...
  meta: {
    modelProps: "user" | "thread" | "threadParticipant" | "message";
    ...
    ThreadParticipant: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.ThreadParticipantCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type ThreadParticipantScalarFieldEnum =
  (typeof ThreadParticipantScalarFieldEnum)[keyof typeof ThreadParticipantScalarFieldEnum];
